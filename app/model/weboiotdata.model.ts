...
const WebOiotDataSchema: Schema = new Schema<IWebOiotData>(
  {
    // Platform Statistics
    totalTrips: {
      type: String,
...
const WebOiotData = mongoose.models.WebOiotData || mongoose.model<IWebOiotData>('WebOiotData', WebOiotDataSchema);
