...
// File: AuthClientLayout.tsx (your existing code, just rename it)
"use client";
        ...
        <div className="container mx-auto px-4 py-8 h-screen flex items-center justify-center">
          <div className="grid lg:grid-cols-2 gap-8 w-full max-w-6xl">
            ...
            >
              <Image
                src="/icons/oiotlogo.png"
                alt="OIOT Logo - One India One Taxi" 
                width={80}
                height={80}
                className="mb-4"
                priority 
              ...
              <p className="text-black text-lg">
                Your journey towards a better experience starts here. Join our community of happy riders with verified drivers and transparent pricing.
              </p>
            </motion.div>
            ...
            <div className="flex items-center justify-center">
              ...
              >
                <div className="lg:hidden flex justify-center mb-6">
                  <Image
                    src="/icons/oiotlogo.png"
                    alt="OIOT - One India One Taxi logo for safe, affordable rides across Karnataka"
                    width={60}
                    height={60}
                  />
                </div>
